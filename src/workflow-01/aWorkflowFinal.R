...
CA_catastrophe_default <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$metodo <- "EstadisticaClasica" # MachineLearning EstadisticaClasica Ninguno
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "A_DT0001", "competencia_2024.csv.gz")
  CA_catastrophe_default( "A_CA0001", "A_DT0001" )
  
  DR_drifting_guantesblancos( "A_DR0001", "A_CA0001" )
  FE_historia_guantesblancos( "A_FE0001", "A_DR0001" )
  
  TS_strategy_guantesblancos_202109( "A_TS0001", "A_FE0001" )
  
  HT_tuning_guantesblancos( "A_HT0001", "A_TS0001" )
  
  # El ZZ depente de HT y TS
  #ZZ_final_guantesblancos( "A_ZZ0001", c("A_HT0001","A_TS0001") )
  
  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "A_ZZ0001", c("A_HT0001","A_TS0001") )
...
corrida_guantesblancos_202109( "Final1" )
